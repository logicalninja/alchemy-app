...
export declare const EthersNetwork: {
    ...
    "polygonzkevm-cardona": string;
    "base-mainnet": string;
    "base-goerli": string;
    "base-sepolia": string;
    "zksync-mainnet": string;
    "zksync-sepolia": string;
    "shape-mainnet": string;
    "shape-sepolia": string;
    "linea-mainnet": string;
    "linea-sepolia": string;
    "fantom-mainnet": string;
    "fantom-testnet": string;
    "zetachain-mainnet": string;
    "zetachain-testnet": string;
    "arbnova-mainnet": string;
    "blast-mainnet": string;
    "blast-sepolia": string;
    "mantle-mainnet": string;
    "mantle-sepolia": string;
    "scroll-mainnet": string;
    "scroll-sepolia": string;
    "gnosis-mainnet": string;
    "gnosis-chiado": string;
    "bnb-mainnet": string;
    "bnb-testnet": string;
    "avax-mainnet": string;
    "avax-fuji": string;
    "celo-mainnet": string;
    "celo-alfajores": string;
