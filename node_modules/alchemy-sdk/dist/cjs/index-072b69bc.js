    ...
    getProvider() {
        if (!this._baseAlchemyProvider) {
            this._baseAlchemyProvider = (() => __awaiter$1(this, void 0, void 0, function* () {
                const { AlchemyProvider } = yield Promise.resolve().then(function () { return require('./alchemy-provider-deb3257d.js'); });
    ...
    getWebSocketProvider() {
        if (!this._baseAlchemyWssProvider) {
            this._baseAlchemyWssProvider = (() => __awaiter$1(this, void 0, void 0, function* () {
                const { AlchemyWebSocketProvider } = yield Promise.resolve().then(function () { return require('./alchemy-websocket-provider-95af450d.js'); });
...
function getNftContractFromRaw(rawNftContract) {
    var _a;
    return nullsToUndefined(Object.assign(Object.assign({}, rawNftContract), { tokenType: parseNftTokenType(rawNftContract.tokenType), openSeaMetadata: Object.assign(Object.assign({}, rawNftContract.openSeaMetadata), { safelistRequestStatus: ((_a = rawNftContract.openSeaMetadata) === null || _a === void 0 ? void 0 : _a.safelistRequestStatus)
    ...
    createWebhook(url, type, params) {
        return __awaiter$1(this, void 0, void 0, function* () {
            ...
            if (type === exports.WebhookType.MINED_TRANSACTION ||
                ...
                type === exports.WebhookType.GRAPHQL) {
                if (!('appId' in params)) {
            ...
            const data = Object.assign(Object.assign(Object.assign(Object.assign({ network, webhook_type: type, webhook_url: url }, (appId && { app_id: appId })), nftFilterObj), (addresses && { addresses })), (graphqlQuery && {
                graphql_query: {
                    query: graphqlQuery,
...
//# sourceMappingURL=index-072b69bc.js.map
